                  ...
                  <tr key={asset.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        <Table className="w-5 h-5 text-gray-400 mr-3" />
                        <div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {asset.row_count == null ? (
                        ...
                        <span className="text-sm text-gray-400 italic" title="Table exists but contains no rows">
                          Empty
                        </span>
                      ) : (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {asset.size_bytes == null ? (
                        ...
                        <span className="text-sm text-gray-400 italic">0 B</span>
                      ) : (
